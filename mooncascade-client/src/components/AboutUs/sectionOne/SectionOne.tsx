  ...
  return (
    <section data-aos="fade-up" className='md:px-28 md:py-28 px-10 py-10 font-primary_font flex flex-col gap-10'>
       ...
       <div className='md:grid md:grid-cols-5 gap-4 flex flex-col border-b-2 border-gray-200 pb-32'>
        <p className='md:col-span-1 md:text-2xl text-lg'>{data.subTitle}</p>
        <div className='md:col-span-4 flex flex-col gap-3'>
         {
            data.description.split('<br />').map((ele: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | React.ReactFragment | React.ReactPortal | null | undefined,i: React.Key | null | undefined)=>(
