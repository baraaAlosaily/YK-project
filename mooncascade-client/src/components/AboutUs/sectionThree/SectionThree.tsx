...
export default function SectionThree({data}: ISectionThree) {
  return (
    <section data-aos="fade-up" className='md:px-28 md:py-28 px-10 py-10 font-primary_font md:grid md:grid-cols-6 flex flex-col gap-8'>
        ...
        <div className='col-span-4'>
            {
                data.moreInfo.moreInfoList.map((ele: any,i: React.Key | null | undefined)=>(
                    <div data-aos="fade-up" key={i} className='md:grid md:grid-cols-2 mb-5 flex flex-col gap-4'>
